    ...
    for ( var rowIdx = 0;  rowIdx < numRows;  rowIdx++ ) {
        ...
        for ( var colIdx = 0;  colIdx < $ths.length;  colIdx++ )
        {
            ...
            if (matrix[rowIdx] === undefined) {
                ...
                matrixSpan[rowIdx] = [];  // create array for this row
            }
            // find 1st empty cell
            ...
            matrixSpan[rowIdx][colCount] = { 'colspan': colspan, 'rowspan': rowspan};
            ...
            for ( var i = 1;  i < rowspan;  i++ ) {
                ...
                for ( var j = (matrix[thisRow]).length;  j < myColCount;  j++ ) {
					...
					matrixSpan[thisRow][j] = { 'colspan': colspan, 'rowspan': rowspan};
                }
                for ( var j = 0;  j < colspan;  j++ ) {  // and empty for my columns
					matrix[thisRow][myColCount+j] = "";
					matrixSpan[thisRow][myColCount+j] = { 'colspan': colspan, 'rowspan': rowspan};
                }
            }
        }
    }
...
var _exportData = function ( dt, inOpts )
{
	...
	var arrayHeader = getHeaders( dt.settings()[0] );
	var headerMatrix = arrayHeader.header;
	var spanMatrix = arrayHeader.span;
